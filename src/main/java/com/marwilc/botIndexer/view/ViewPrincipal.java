package com.marwilc.botIndexer.view;
...
public class ViewPrincipal extends JFrame implements ActionListener, MouseListener
{
	...
	private JTextArea textAreaDomain;
	private JTextArea textAreaEmail;
	private JMenuItem mntmAddFileAccounts;
	private JMenuItem mntmAddFileDomain;
	...
	public ViewPrincipal(Manager manager)
	{
		...
		mntmAddFileAccounts = new JMenuItem("Add Gmail Accounts");
		mnFile.add(mntmAddFileAccounts);
		
		mntmAddFileDomain = new JMenuItem("Add File Domains");
		mnFile.add(mntmAddFileDomain);
		...
		mntmAddFileAccounts.addActionListener(this);
		mntmAddFileDomain.addActionListener(this);
	...
	public JButton getBtnCopyTextAreaEmail()
	{
		return btnCopyTextAreaEmail;
	}

	public void setBtnCopyTextAreaEmail(JButton btnCopyTextAreaEmail)
	{
		this.btnCopyTextAreaEmail = btnCopyTextAreaEmail;
	}

	public JButton getBtnCopyTextAreaDomain()
	{
		return btnCopyTextAreaDomain;
	}
	public void setBtnCopyTextAreaDomain(JButton btnCopyTextAreaDomain)
	{
		this.btnCopyTextAreaDomain = btnCopyTextAreaDomain;
	}
	public JTextArea getTextAreaEmail()
	{
		return textAreaEmail;
	}

	public void setTextAreaEmail(JTextArea textAreaEmail)
	{
		this.textAreaEmail = textAreaEmail;
	}
	...
	public void setTextAreaDomain(JTextArea textAreaDomain)
	{
		this.textAreaDomain = textAreaDomain;
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == mntmAddFileAccounts){
			myManager.initEventAddFileAccounts();
		}
		
		if(e.getSource() == mntmAddFileDomain){
